# 📧 Wysa Partnership/Acquisition Outreach
...
**To:** partnerships@wysa.ai (or partnerships@touchkin.com)
**CC:** [If you can find a specific contact]

---

Dear Wysa Partnerships Team,

I hope this finds you well. I'm reaching out because I've built something that I believe could complement Wysa's mission of making mental health support accessible to everyone.
...
| Feature | Typical AI Therapy | Optimism Engine |
|---------|-------------------|-----------------|
| Questions | Template-based | Generated in real-time based on emotion |
| Depth | Surface check-ins | 4-layer "Iceberg" progression (Surface → Trigger → Emotion → Core Belief) |
| Repetition | Common complaint | Tracks and never repeats questions |
| Personalization | Per-session only | Cross-session memory of topics, distortions, insights |

**Sample Interaction:**

*User:* "I feel worthless when people criticize me online"
...
- 7 AI provider integrations (no vendor lock-in)
- Security-hardened (protected APIs, rate limiting, input validation, CSP headers)
- Clerk authentication + Neon PostgreSQL
- 30+ beta users with strong feedback
...
| Company | Contact | Why |
|---------|---------|-----|
| **Woebot Health** | partnerships@woebot.io | Direct competitor, may want defensive acquisition |
| **Youper** | contact@youper.ai | Smaller player, could differentiate with depth |
| **MentalHealth.com** | Recent Therapy.ai acquirer | Already buying AI therapy tech |
| **Talkspace/BetterHelp** | Corporate development | Could add AI between sessions |
| **Calm/Headspace** | partnerships@calm.com | Expanding into therapy, may want CBT engine |
